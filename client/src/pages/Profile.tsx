              ...
              >
                <div 
                  ...
                  style={{ 
                    ...
                    color: account.isCustomIcon && account.connected ? 'black' : 'white'
                  }}
                >
                  {/* Render custom icons or lucide icons */}
                  {account.icon ? (
                    <account.icon className="w-4 h-4 fill-current" />
                  ) : (
                    // Fallback for custom SVG icons if needed, or just a placeholder
                    // In a real app we'd have proper SVG components for all
                    <Globe size={16} />
                  )}
                </div>
