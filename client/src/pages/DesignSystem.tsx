      ...
      <div className="min-h-screen bg-background p-6 pb-24 space-y-12">
        ...
        <section className="space-y-4">
          ...
          <div className="space-y-2">
            ...
            <div className="grid grid-cols-2 gap-4">
              <div className="space-y-2">
                <div className="h-20 rounded-xl bg-primary shadow-lg flex items-center justify-center text-white font-bold">Primary</div>
                <p className="text-xs text-gray-500">#7C3AED (Electric Purple)</p>
              </div>
              <div className="space-y-2">
                <div className="h-20 rounded-xl bg-accent shadow-lg flex items-center justify-center text-black font-bold">Accent</div>
          ...
          <div className="space-y-2">
            ...
            <div className="grid grid-cols-3 gap-4">
              <div className="space-y-2">
                <div className="h-20 rounded-xl bg-background border border-white/10 flex items-center justify-center text-gray-400">Bg</div>
                <p className="text-xs text-gray-500">#121212</p>
              </div>
              <div className="space-y-2">
                <div className="h-20 rounded-xl bg-card border border-white/10 flex items-center justify-center text-gray-400">Card</div>
                <p className="text-xs text-gray-500">#1E1E1E</p>
              </div>
              <div className="space-y-2">
                <div className="h-20 rounded-xl bg-muted border border-white/10 flex items-center justify-center text-gray-400">Muted</div>
        ...
        <section className="space-y-4">
          ...
          <div className="space-y-4">
            <div className="p-6 rounded-xl border border-white/10 bg-card space-y-4">
